...
from data4allnlp.train.callback import Callback
import json
        ...
        for epoch in range(self.max_epochs):
            ...
            for batch in self.train_loader:
                ...
                if self.val_loader and (global_step % self.validate_every == 0):
                    ...
                    print(f"Epoch {epoch+1}, Step {global_step}, Validation - Loss: {val_loss:.4f}, Accuracy: {val_accuracy:.4f}") 
                    for callback in self.callbacks:
                        callback.on_validation_end(self, val_loss, val_accuracy, global_step)
